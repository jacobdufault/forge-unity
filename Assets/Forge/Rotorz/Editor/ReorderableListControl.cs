...
using ForgeRotorz.ReorderableList.Internal;

namespace ForgeRotorz.ReorderableList {
    ...
    public class ReorderableListControl {
        ...
        /// <returns>A value of <c>true</c> if clicked; otherwise <c>false</c>.</returns>
        ...
        /// </summary>
        /// <param name="controlID">Unique ID of list control.</param>
        /// <returns>A value of <c>true</c> if item is being tracked; otherwise
        /// <c>false</c>.</returns>
        ...
        /// <param name="itemIndex">Zero-based index of item which was right-clicked.</param>
        /// <param name="adaptor">Reorderable list adaptor.</param>
        /// <returns>A value of <c>true</c> if command was known; otherwise <c>false</c>.</returns>
